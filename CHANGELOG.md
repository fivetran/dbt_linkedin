...
## Feature update 🎉
- Unioning capability! This adds the ability to union source data from multiple linkedin connectors. Refer to the [README](https://github.com/fivetran/dbt_linkedin/blob/main/README.md) for more details.
